    ...
    if matches:
        for match in matches:
            ...
            if def_use_error(_sum_):
                explain("The addition on the first iteration step is not correct because either the property "
...
def m_wrong_duplicate_var_in_add():
    ...
    if match:
        explain("You are adding the same variable twice; you need two different variables in your addition.<br><br><i>"
                "(dup_var)<i></br>")
