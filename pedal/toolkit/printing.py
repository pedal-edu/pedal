...
def ensure_prints(count):
    ...
    if not prints:
        gently("You are not using the print function!<br><br><i>(no_print)<i></br></br>")
        return False
    elif len(prints) > count:
        gently("You are printing too many times!<br><br><i>(multiple_print)<i></br></br>")
        return False
    elif len(prints) < count:
        gently("You are not printing enough things!<br><br><i>(too_few_print)<i></br></br>")
        return False
    else:
