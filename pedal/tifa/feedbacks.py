...
class action_after_return(TifaFeedback):
    ...
    text_template = ("You performed an action after already returning from a "
                     "function, on line {location.line}. You can only return on"
                     " a path once.")
...
class return_outside_function(TifaFeedback):
    ...
    text_template = ("You attempted to return outside of a function on line "
...
class multiple_return_types(TifaFeedback):
    ...
    text_template = ("Your function returned {actual} on line {location.line}, "
...
class unused_variable(TifaFeedback):
    ...
    message_template = ("The {kind} `{name}` was given a {initialization} on line "
...
class type_changes(TifaFeedback):
    """ Type changes """
    title = "Type Changes"
    message_template = ("The variable `{name}` changed type from `{old}` to "
...
class incorrect_arity(TifaFeedback):
    ...
    def __init__(self, location, function_name, **kwargs):
        super().__init__(location=location, function_name=function_name, **kwargs)
