...
def blank_source(group=None, report=MAIN_REPORT):
    return feedback(blank_source.__name__, category=feedback.CATEGORIES.SYNTAX, tool=TOOL_NAME_SOURCE,
...
def source_file_not_found(filename, sections, report=MAIN_REPORT):
    ...
    return feedback(source_file_not_found.__name__, category=feedback.CATEGORIES.SYNTAX, tool=TOOL_NAME_SOURCE,
