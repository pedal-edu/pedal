...
# Problem 1: Create a `factorial` function with some unit tests.
next_section()

# Let's make sure they have enough code covered before we give them feedback.
ensure_coverage(.75)
...
# Make sure problem_1_factorial_defined runs before problem_1_factorial_unit_tests
@precondition(problem_1_factorial_defined)
# try_all decorator allows us to continue trying even after an assertion fails
@try_all()
def problem_1_factorial_unit_tests():
    ...
    # Notice we can assign some credit to this unit test
